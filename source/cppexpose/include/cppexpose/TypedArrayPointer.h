...
/**
*  @brief
*    Representation of a pointer to an Array
*/
template <typename Type>
class CPPEXPOSE_TEMPLATE_API TypedArrayPointer : public ValueStorage<Type>
{
public:
    /**
    *  @brief
    ...
    */
    ...
    TypedArrayPointer(Args&&... args);

    /**
    *  @brief
    *    Destructor
    */
    virtual ~TypedArrayPointer();
