...
class CPPEXPOSE_TEMPLATE_API TypedFilePath : public ValueStorage<Type>
{
public:
    /**
    *  @brief
...
protected:
    std::vector<std::string> m_choices; ///< List of available values
};
